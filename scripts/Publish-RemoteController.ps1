...
$packageFiles = @('Install-RemoteController.ps1', 'Uninstall-RemoteController.ps1', 'Start-RemoteController.cmd', 'Start-RemoteControllerUiTest.cmd', 'Repair-RemoteControllerTlsIdentity.ps1', 'Test-RemoteControllerUi.ps1', 'Setup-RemoteControllerAgent.ps1', 'Setup-RemoteControllerAgent.cmd', 'RemoteController.Agent.config.json')
foreach ($name in $projects.Keys) {
